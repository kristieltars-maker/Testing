export const ru = {
    ...
    "start.welcome": "👋 Добро пожаловать!\n\nВсе команды — кнопка «📋 Список команд». Настройки — «⚙️ Настройки».",
    "help.keyboard_hint": "💡 Агент, модель, вариант и действия с контекстом доступны через нижние кнопки клавиатуры.",
    ...
    "messages.project_not_selected": "🏗 Проект не выбран.\n\nСначала выберите проект командой /projects.",
    "messages.session_not_selected": "💬 Сессия не выбрана.\n\nСначала выберите сессию через /sessions или создайте новую через /new.",
    "messages.session_project_mismatch": "⚠️ Выбранная сессия не соответствует текущему проекту. Повторно выберите сессию через /sessions.",
    ...
    "messages.fetch_error": "🔴 OpenCode Server недоступен или произошла ошибка при получении списка сообщений.",
    ...
    "opencode_stop.pid_not_found": "⚠️ OpenCode Server отвечает на порту {port}, но локальный процесс для остановки найти не удалось.",
    ...
    "skills.confirm": "Подтвердите запуск скилла {skill}. Чтобы запустить его с аргументами, отправьте аргументы следующим сообщением.",
    ...
    "skills.arguments_empty": "⚠️ Аргументы не могут быть пустыми. Отправьте текст или нажмите Выполнить.",
