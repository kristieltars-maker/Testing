import { clearInteractionErrorState, } from "../../app/managers/interaction-manager.js";
...
import { handleHubCallback } from "./hub-callback-handler.js";
...
function parseCallbackPrefix(data) {
    ...
    const routes = new Map([
        [
            "hub",
            {
                name: "hub",
                handlers: [
                    (ctx) => handleHubCallback(ctx, deps),
                ],
        ...
        [
            "commands",
            {
                name: "commands",
                handlers: [
                    (ctx) => handleCommandsCallback(ctx, {
                        bot,
        ...
        [
            "messages",
            {
                name: "messages",
                handlers: [
                    (ctx) => handleMessagesCallback(ctx, {
                        bot,
                        ensureEventSubscription: deps.ensureEventSubscription,
                    }),
                ],
        ...
        [
            "worktree",
            {
                name: "worktree",
                handlers: [
                    (ctx) => handleWorktreeCallback(ctx, {
                        ensureEventSubscription: deps.ensureEventSubscription,
                    }),
                ],
                errorScope: "interaction",
